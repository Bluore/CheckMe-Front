    ...
    <div class="main-content">
      ...
      <div class="sidebar">
        ...
        <div class="contact-info">
            ...
            <p>
              Twitter:
              <a :href="userStore.profile.socialLinks.twitter" target="_blank">
                {{ userStore.profile.socialLinks.twitter }}
              </a>
            </p>
          ...
          <h3>开源</h3>
          <p>
            本项目开源在<a href="https://github.com/Bluore/CheckMe" target="_blank">GitHub</a>
          </p>
          欢迎来部署玩玩 (,,・ω・,,)
        </div>
      </div>
